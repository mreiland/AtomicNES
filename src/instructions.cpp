...
//     instr_tbl[0x02] = make_instruction(0x02,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x03] = make_instruction(0x03,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x04] = make_instruction(0x04,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x07] = make_instruction(0x07,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x0B] = make_instruction(0x0B,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x0C] = make_instruction(0x0C,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x0F] = make_instruction(0x0F,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x12] = make_instruction(0x12,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x13] = make_instruction(0x13,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x14] = make_instruction(0x14,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x17] = make_instruction(0x17,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x1A] = make_instruction(0x1A,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x1B] = make_instruction(0x1B,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x1C] = make_instruction(0x1C,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x1F] = make_instruction(0x1F,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x22] = make_instruction(0x22,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x23] = make_instruction(0x23,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x27] = make_instruction(0x27,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x2B] = make_instruction(0x2B,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x2F] = make_instruction(0x2F,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x32] = make_instruction(0x32,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x33] = make_instruction(0x33,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x34] = make_instruction(0x34,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x37] = make_instruction(0x37,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x3A] = make_instruction(0x3A,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x3B] = make_instruction(0x3B,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x3C] = make_instruction(0x3C,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x3F] = make_instruction(0x3F,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x42] = make_instruction(0x42,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x43] = make_instruction(0x43,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x44] = make_instruction(0x44,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x47] = make_instruction(0x47,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x4B] = make_instruction(0x4B,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x4F] = make_instruction(0x4F,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x52] = make_instruction(0x52,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x53] = make_instruction(0x53,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x54] = make_instruction(0x54,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x57] = make_instruction(0x57,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x5A] = make_instruction(0x5A,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x5B] = make_instruction(0x5B,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x5C] = make_instruction(0x5C,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x5F] = make_instruction(0x5F,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x62] = make_instruction(0x62,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x63] = make_instruction(0x63,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x64] = make_instruction(0x64,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x67] = make_instruction(0x67,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x6B] = make_instruction(0x6B,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x6F] = make_instruction(0x6F,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x72] = make_instruction(0x72,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x73] = make_instruction(0x73,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x74] = make_instruction(0x74,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x77] = make_instruction(0x77,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x7A] = make_instruction(0x7A,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x7B] = make_instruction(0x7B,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x7C] = make_instruction(0x7C,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x7F] = make_instruction(0x7F,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x80] = make_instruction(0x80,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x82] = make_instruction(0x82,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x83] = make_instruction(0x83,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x87] = make_instruction(0x87,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x89] = make_instruction(0x89,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x8B] = make_instruction(0x8B,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x8F] = make_instruction(0x8F,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x92] = make_instruction(0x92,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x93] = make_instruction(0x93,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x97] = make_instruction(0x97,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x9B] = make_instruction(0x9B,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x9C] = make_instruction(0x9C,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x9E] = make_instruction(0x9E,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0x9F] = make_instruction(0x9F,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xA3] = make_instruction(0xA3,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xA7] = make_instruction(0xA7,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xAB] = make_instruction(0xAB,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xAF] = make_instruction(0xAF,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xB2] = make_instruction(0xB2,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xB3] = make_instruction(0xB3,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xB7] = make_instruction(0xB7,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xBB] = make_instruction(0xBB,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xBF] = make_instruction(0xBF,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xC2] = make_instruction(0xC2,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xC3] = make_instruction(0xC3,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xC7] = make_instruction(0xC7,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xCB] = make_instruction(0xCB,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xCF] = make_instruction(0xCF,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xD2] = make_instruction(0xD2,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xD3] = make_instruction(0xD3,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xD4] = make_instruction(0xD4,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xD7] = make_instruction(0xD7,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xDA] = make_instruction(0xDA,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xDB] = make_instruction(0xDB,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xDC] = make_instruction(0xDC,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xDF] = make_instruction(0xDF,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xE2] = make_instruction(0xE2,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xE3] = make_instruction(0xE3,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xE7] = make_instruction(0xE7,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xEB] = make_instruction(0xEB,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xF2] = make_instruction(0xF2,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xF3] = make_instruction(0xF3,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xF4] = make_instruction(0xF4,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xF7] = make_instruction(0xF7,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xFA] = make_instruction(0xFA,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xFB] = make_instruction(0xFB,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xFC] = make_instruction(0xFC,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xFE] = make_instruction(0xFE,opcode::None, addressing_mode::None,   -1, -1);
//     instr_tbl[0xFF] = make_instruction(0xFF,opcode::None, addressing_mode::None,   -1, -1);
  }
}
