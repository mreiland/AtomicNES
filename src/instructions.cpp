...
namespace instructions {
  ...
  void initialize() {
    ...
    instructions_array[0x05]  = make_instruction(0x05,opcode::ORA,  addr_mode::ZP,   2, 3, 0);
     ...
     instructions_array[0x09] = make_instruction(0x09,opcode::ORA, addr_mode::Immediate,   2, 2, 0);
     instructions_array[0x0A] = make_instruction(0x0A,opcode::ASL, addr_mode::Accumulator, 1, 2, 0);
     ...
     instructions_array[0x10] = make_instruction(0x10,opcode::BPL, addr_mode::Relative,   2, 2, 2);
     ...
     instructions_array[0x29] = make_instruction(0x29,opcode::AND, addr_mode::Immediate,   2, 2, 0);
     instructions_array[0x2A] = make_instruction(0x2A,opcode::ROL, addr_mode::Accumulator, 1, 2, 0);
...
// TODO: look closer at this, the description isn't clear
     instructions_array[0x30] = make_instruction(0x30,opcode::BMI, addr_mode::Relative,   2, 2, 2);
     ...
     instructions_array[0x48] = make_instruction(0x48,opcode::PHA, addr_mode::Implied,   1, 2, 0);
     instructions_array[0x49] = make_instruction(0x49,opcode::EOR, addr_mode::Immediate,   2, 2, 0);
     instructions_array[0x4A] = make_instruction(0x4A,opcode::LSR, addr_mode::Accumulator, 1, 2, 0);
     ...
     instructions_array[0x50] = make_instruction(0x50,opcode::BVC, addr_mode::Relative,   2, 2, 2);
     ...
     instructions_array[0x69] = make_instruction(0x69,opcode::ADC, addr_mode::Immediate,   2, 2, 0);
     instructions_array[0x6A] = make_instruction(0x6A,opcode::ROR, addr_mode::Accumulator,  1, 2, 0);
     ...
     instructions_array[0x70] = make_instruction(0x70,opcode::BVS, addr_mode::Relative,   2, 2, 2);
...
// TODO: look closer at this, the description isn't clear
     instructions_array[0x90] = make_instruction(0x90,opcode::BCC, addr_mode::Relative,   2, 2, 2);
     ...
     instructions_array[0xA0] = make_instruction(0xA0,opcode::LDY, addr_mode::Immediate,   2, 2, 0);
     instructions_array[0xA1] = make_instruction(0xA1,opcode::LDA, addr_mode::INDX,   2, 6, 0);
     instructions_array[0xA2] = make_instruction(0xA2,opcode::LDX, addr_mode::Immediate,   2, 2, 0);
     ...
     instructions_array[0xA9] = make_instruction(0xA9,opcode::LDA, addr_mode::Immediate,   2, 2, 0);
...
// TODO: look closer at this, the description isn't clear
     instructions_array[0xB0] = make_instruction(0xB0,opcode::BCS, addr_mode::Relative,   2, 2, 2);
     ...
     instructions_array[0xBE] = make_instruction(0xBE,opcode::LDX, addr_mode::ABSY,   3, 4, 0);
     instructions_array[0xC0] = make_instruction(0xC0,opcode::CPY, addr_mode::Immediate,   2, 2, 0);
     ...
     instructions_array[0xC9] = make_instruction(0xC9,opcode::CMP, addr_mode::Immediate,   2, 2, 0);
     ...
     instructions_array[0xD0] = make_instruction(0xD0,opcode::BNE, addr_mode::Relative,   2, 2, 2);
     ...
     instructions_array[0xE0] = make_instruction(0xE0,opcode::CPX, addr_mode::Immediate,   2, 2, 0);
     ...
     instructions_array[0xE9] = make_instruction(0xE9,opcode::SBC, addr_mode::Immediate,  2, 2, 0);
...
// TODO: look closer at this, the description isn't clear
     instructions_array[0xF0] = make_instruction(0xF0,opcode::BEQ, addr_mode::Relative,   2, 2, 2);
